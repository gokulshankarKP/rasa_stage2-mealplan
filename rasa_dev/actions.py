...
class ActionCertaindaysPlan(Action):
    ...
    async def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        prompt = f"""
        the data of the recipe with details 
        {recipe_text} and my child age is {age} and height {height} and weight is {weight} and lactose suggestion {lactose_intolerant} and 
        please good recipe for {certaindays_output} days each day with breakfast , lunch , dinner and snacks without repetitive recipe from this data and give details of recipe name , description , incredients present with recipe for example day1 morning , lunch , snacks , dinner with title day1 followed by other  days ........
        """
...
class ActionCertaindaysFallbackQuestion(Action):
    ...
    async def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        {certain_days_question} days each day with breakfast , lunch , dinner and snacks from this data and give details of recipe name , description , incredients , steps , nutrients present recipe , and show product with nestle product of {nestle_products_text}.
        """
